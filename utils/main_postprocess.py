...
class SegPostprocessing:
    def __init__(self, binarization_threshold=0.3, confidence_threshold=0.7, shrink_ratio=1.5, min_area=10., intersection_threshold=None):
        self.binarization_threshold = binarization_threshold
        self.confidence_threshold = confidence_threshold
        self.unclip_ratio = shrink_ratio
