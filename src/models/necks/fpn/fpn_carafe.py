...
class FPNCarafe(nn.Module):
    def __init__(self, in_channels, inner_channels=256, **kwargs):
        ...
        print(in_channels)
        self.up_4 = CARAFE(inner_channels)
        self.up_3 = CARAFE(inner_channels)
        self.up_2 = CARAFE(inner_channels)
        # reduce layers
    ...
    def forward(self, x):
        ...
        p3 = self.up_3(p4) + self.reduce_conv_c3(c3)
        p3 = self.smooth_p4(p3)
        p2 = self.up_2(p3) + self.reduce_conv_c2(c2)
